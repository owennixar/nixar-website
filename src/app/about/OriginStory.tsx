    ...
    <section className="bg-white py-24 lg:py-32">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-5 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <AnimateIn direction="right" distance={30} delay={0.15}>
          <div className="aspect-[4/3] overflow-hidden rounded-2xl bg-gradient-to-br from-[var(--color-bg-alt)] via-[var(--color-primary-light)] to-[var(--color-bg-alt)] shadow-lg">
            <div className="flex h-full items-center justify-center">
              <div className="text-center">
                ...
                <p className="mt-3 text-sm font-500 text-[var(--color-text-muted)]">
