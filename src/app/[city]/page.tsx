          ...
          <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8">
            ...
            <AnimateIn delay={0.35} direction="none">
              <p className="mt-5 max-w-2xl text-[1.05rem] leading-[1.7] text-white/85">
                NIXAR Solutions brings AI-powered digital marketing to {city.name}
                {city.state ? `, ${city.state}` : ", TX"}.
          ...
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-5 lg:grid-cols-5 lg:gap-16 lg:px-8">
            <div className="lg:col-span-3">
              ...
              <AnimateIn direction="left" distance={20} delay={0.25}>
                <p className="mt-4 text-[16px] leading-[1.8] text-white/85">
                  {city.isExpansion
                    ? `NIXAR Solutions is headquartered in Frisco, Texas, and we operate as a remote-first agency for ${city.name} businesses. We bring the same AI-powered SEO, web development, and brand strategy that wins in Dallas-Fort Worth to ${city.name}'s unique market. Our playbook is built for competitive metros. which is exactly what ${city.name} demands.`
                    : `NIXAR Solutions is based in Frisco. right in the heart of the DFW metroplex. and we understand the ${city.name} market at a granular level. We know which keywords drive local traffic, how ${city.name} consumers research businesses, and what it takes to stand out in ${city.county}. Our AI-powered approach means faster results with more precision than traditional agencies can deliver.`}
                </p>
              </AnimateIn>
            </div>
            ...
            <AnimateIn direction="right" distance={30} delay={0.15} className="lg:col-span-2">
              <div className="rounded-2xl bg-white/[0.04] backdrop-blur-sm border border-white/10 p-7">
                <h3 className="font-[family-name:var(--font-heading)] text-[16px] font-700 text-white">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {city.keyIndustries.map((ind) => (
                    <span
                      key={ind}
                      className="rounded-full bg-white/[0.02] px-3 py-1.5 text-[16px] font-500 text-white/85"
                    >
                      {ind}
                    </span>
                  ))}
                ...
                <div className="mt-8 border-t border-white/10 pt-6">
                  ...
                  <dl className="mt-3 space-y-3 text-[16px]">
                    ...
                    <div className="flex justify-between">
                      <dt className="text-white/75">County</dt>
            ...
            <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
              <AnimateIn delay={0.1}>
                <div className="glass-card rounded-2xl p-7">
                  ...
                  <p className="mt-3 text-[16px] leading-[1.75] text-gray-300">
          ...
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
              ...
              {topServices.map((s, i) => (
                <AnimateIn key={s.slug} delay={0.05 * i}>
                  ...
                  >
                    ...
                    <ArrowRight size={16} className="shrink-0 text-white/75 transition-colors group-hover:text-[#E71840]" />
                  </Link>
                </AnimateIn>
              ))}
            </div>
            ...
            <AnimateIn delay={0.3}>
              <div className="mt-8">
                <Link
                  href="/services"
                  className="text-[16px] font-600 text-[#E71840] transition-colors hover:text-[#C41535]"
                >
          ...
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <AnimateIn delay={0.05}>
                <Link
                  href="/dallas"
                  className="flex items-center gap-2 rounded-full bg-[#E71840] px-5 py-2.5 text-[16px] font-600 text-white transition-all hover:bg-[#C41535]"
                >
                  <MapPin size={13} />
                  Dallas (Hub)
                </Link>
              ...
              {nearbyCities.map((nc, i) => (
                <AnimateIn key={nc.slug} delay={0.05 + 0.04 * i}>
                  <Link
                    ...
                    className="flex items-center gap-2 rounded-full bg-white/[0.04] backdrop-blur-sm border border-white/10 px-5 py-2.5 text-[16px] font-500 text-white/85 transition-all hover:bg-[#E71840]/10 hover:text-[#E71840]"
                  >
                    <MapPin size={13} />
                    {nc.name}
                  </Link>
              ...
              <AnimateIn delay={0.3}>
                <Link
                  href="/dallas"
                  className="flex items-center gap-2 rounded-full border border-dashed border-white/10 px-5 py-2.5 text-[16px] font-500 text-white/75 transition-all hover:border-[#E71840] hover:text-[#E71840]"
                >
