...
const CITIES = ["Bogotá", "Medellín", "Cartagena", "Barranquilla", "Cali"];

const INDUSTRIES = [
  "Fintech & Nearshore Banking",
  "Tourism & Hospitality",
  "Export & Logistics",
  "Coffee, Flowers & Agroindustry",
...
export const metadata: Metadata = {
  title: "Marketing Agency Colombia | Bilingual SEO & AI Marketing | NIXAR Solutions",
  description:
    "NIXAR Solutions brings AI-powered digital marketing to businesses across Colombia. Bilingual SEO, web development, and brand strategy for Bogotá, Medellín, Cartagena, Barranquilla, and Cali. Rooted in Colombian heritage.",
  alternates: { canonical: "https://nixarsolutions.com/colombia" },
};
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8">
            ...
            <AnimateIn delay={0.2}>
              <h1 className="mt-5 max-w-3xl font-[family-name:var(--font-heading)] text-[clamp(2.25rem,5vw,4.25rem)] font-900 leading-[1.08] tracking-tight text-white">
                ...
                <span className="text-[#E71840]">Colombia</span>
              </h1>
            </AnimateIn>

            <AnimateIn delay={0.35} direction="none">
              <p className="mt-5 max-w-2xl text-[1.05rem] leading-[1.7] text-white/85">
                Bilingual SEO, web development, and AI-powered brand strategy for Colombian
                businesses. Built by a team with deep Colombian roots, serving clients across
                Bogotá, Medellín, Cartagena, Barranquilla, and Cali.
              </p>
            </AnimateIn>
            ...
            <div className="lg:col-span-3">
              <AnimateIn direction="left" distance={30}>
                ...
                <h2 className="mt-4 font-[family-name:var(--font-heading)] text-[clamp(1.75rem,3.5vw,2.5rem)] font-800 leading-tight tracking-tight text-white">
                  Why Colombia Is Personal for Us
                </h2>
              </AnimateIn>

              <AnimateIn direction="left" distance={20} delay={0.1}>
                <p className="mt-6 text-[16px] leading-[1.8] text-white/85">
                  NIXAR Solutions co-founder Anwar Mirza is of Colombian heritage, and
                  Colombia is not a new market for our family. it is where our entrepreneurial
                  story began. Our family has deep, multi-decade ties to the Colombian
                  business community through Akorbi and Fluenta, two internationally recognized
                  companies founded and led by Claudia Mirza. Both companies have built their
                  reputations serving global enterprise clients with language services,
                  technology, and business process solutions. and both were built on a
                  foundation of Colombian talent, Colombian values, and Colombian resilience.
                </p>
              </AnimateIn>

              <AnimateIn direction="left" distance={20} delay={0.18}>
                <p className="mt-4 text-[16px] leading-[1.8] text-white/85">
                  That legacy shapes how NIXAR approaches the Colombian market. We know
                  Colombia is not one uniform market. it is Bogotá&apos;s corporate and fintech
                  corridor, Medellín&apos;s innovation and design scene, Cartagena&apos;s
                  tourism and luxury real estate, Barranquilla&apos;s logistics and industrial
                  base, and Cali&apos;s manufacturing and agroindustry. Each region requires a
                  different digital playbook, and we build each one from the inside out.
                </p>
              </AnimateIn>

              <AnimateIn direction="left" distance={20} delay={0.25}>
                <p className="mt-4 text-[16px] leading-[1.8] text-white/85">
                  What we offer Colombian businesses is what we offer every NIXAR client:
                  AI-powered SEO that ranks in Spanish and English, conversion-focused web
                  development, brand systems that travel globally, and paid media that
                  respects both the Colombian buyer journey and international audiences. The
                  difference is that when we work in Colombia, we are working in a market our
                  family has helped shape for decades.
                </p>
              </AnimateIn>
            </div>
                ...
                <div className="mt-8 border-t border-white/10 pt-6">
                  ...
                  <dl className="mt-3 space-y-3 text-[16px]">
                    <div className="flex justify-between">
                      ...
                      <dd className="font-600 text-white">Bogotá</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-white/75">Population</dt>
                      <dd className="font-600 text-white">52M+</dd>
                    </div>
                    <div className="flex justify-between">
        ...
        <section className="py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            <AnimateIn>
              ...
              <h2 className="mt-4 font-[family-name:var(--font-heading)] text-[clamp(1.75rem,3.5vw,2.5rem)] font-800 leading-tight tracking-tight text-white">
                Services for Colombian Businesses
              </h2>
            </AnimateIn>
