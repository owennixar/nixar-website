...
const SERVICE_HERO_IMAGES: Record<string, { src: string; alt: string; overlay?: boolean }> = {
  ...
  "content-marketing": {
    ...
    alt: "Content marketing strategy and editorial planning by NIXAR Solutions Dallas",
    overlay: true,
  },
  "ai-seo-geo": {
    src: "/images/service-geo.webp",
    alt: "AI SEO and generative engine optimization by NIXAR Solutions Dallas",
    overlay: true,
  },
  "branding-brand-identity": {
    src: "/images/service-branding.webp",
    alt: "Brand identity and visual design by NIXAR Solutions Dallas",
    overlay: true,
  },
  "paid-advertising": {
    src: "/images/service-ads.webp",
    alt: "Paid advertising and performance marketing by NIXAR Solutions Dallas",
    overlay: true,
  },
};
