    ...
    <>
      <main className="bg-[#0a0a0a]">
        ...
        <section className="relative w-full overflow-hidden" style={{ height: '50vh' }}>
          <img src="/images/free-audit-hero.webp" alt="Free digital marketing audit dashboard analysis by NIXAR Solutions Dallas" loading="eager" decoding="sync" className="absolute inset-0 w-full h-full object-cover" />
